...
![version](https://img.shields.io/badge/version-0.1.0-blue) ![python](https://img.shields.io/badge/python-%3E%3D3.10-blue) ![coverage](https://img.shields.io/badge/coverage-unknown-lightgrey) ![functions](https://img.shields.io/badge/functions-613-green)
> **613** functions | **70** classes | **173** files | CC̄ = 3.9
...
```
planfile/
├── cleanup_redundant├── docker-entrypoint├── run_examples├── auto_generate_planfile├── project    ├── run    ├── validate_with_llx        ├── run        ├── run        ├── 04_javascript_client        ├── 01_start_server        ├── run_all        ├── 02_curl_examples├── mcp-server-example        ├── run        ├── run        ├── run        ├── run        ├── run        ├── run        ├── demo        ├── run        ├── run        ├── ci-workflow        ├── run        ├── 03_python_client        ├── 02_mcp_integration    ├── PROPOSED_API_IMPROVEMENTS        ├── 01_full_workflow    ├── llx_validator        ├── run_all        ├── 04_advanced_filtering        ├── 04_analytics_simple        ├── 03_proxy_routing        ├── 03_integration_simple        ├── 01_basic_usage        ├── run        ├── planfile-sync        ├── run        ├── run_fixed        ├── run        ├── 02_ticket_management        ├── run        ├── run_fixed        ├── verify_planfile        ├── run    ├── server_common    ├── examples        ├── 03_integration    ├── execution├── planfile/    ├── runner    ├── models        ├── state        ├── 04_llx_integration    ├── executor_standalone    ├── sync/    ├── ci        ├── mock        ├── utils        ├── gitlab        ├── github        ├── generic        ├── markdown_backend/            ├── files        ├── operations            ├── backend            ├── tickets            ├── constants        ├── cli_loader    ├── loaders/        ├── yaml_loader        ├── external_tools    ├── analysis/        ├── generator        ├── models        ├── file_analyzer        ├── generators/            ├── metrics_extractor        ├── sprint_generator        ├── parsers/        ├── jira            ├── json_parser            ├── yaml_parser        ├── store            ├── toon_parser    ├── core/        ├── models/            ├── text_parser        ├── store_files        ├── store_tickets            ├── ticket            ├── base        ├── common        ├── redup_importer    ├── importers/        ├── yaml_importer        ├── json_importer        ├── base        ├── auto_loop        ├── commands        ├── extra_commands            ├── strategy        ├── project_detector/        ├── __main__    ├── cli/            ├── sync/                ├── commands                ├── commands            ├── review/                ├── core                ├── utils            ├── health/                ├── commands            ├── examples/        ├── code2llm_importer            ├── query/                ├── commands            ├── apply/                ├── commands                ├── commands            ├── init/                ├── utils            ├── auto/                ├── commands            ├── generate/                ├── commands            ├── ticket/                ├── commands            ├── validate/            ├── progress            ├── errors            ├── registry                ├── commands        ├── core/            ├── console            ├── fallback            ├── readme            ├── license            ├── package            ├── base            ├── structure            ├── git            ├── gates        ├── vallm_importer            ├── model_tier            ├── main            ├── pyproject            ├── inference        ├── prompts        ├── adapters    ├── llm/        ├── generator    ├── extensions/        ├── client        ├── priorities    ├── utils/    ├── mcp/        ├── metrics        ├── base    ├── integrations/        ├── server        ├── gitlab        ├── github        ├── jira        ├── generic    ├── api/        ├── server                ├── commands        ├── config```
...
📄 `planfile.analysis.generator` (20 functions, 1 classes)
...
We welcome contributions! Please see [CONTRIBUTING.md](https://github.com/wronai/planfile/blob/main/CONTRIBUTING.md) for guidelines.
...
| `docs/api.md` | Consolidated API reference | [View](https://github.com/wronai/planfile/blob/main/docs/api.md) |
| `docs/modules.md` | Module reference with metrics | [View](https://github.com/wronai/planfile/blob/main/docs/modules.md) |
| `docs/architecture.md` | Architecture with diagrams | [View](https://github.com/wronai/planfile/blob/main/docs/architecture.md) |
| `docs/dependency-graph.md` | Dependency graphs | [View](https://github.com/wronai/planfile/blob/main/docs/dependency-graph.md) |
| `docs/coverage.md` | Docstring coverage report | [View](https://github.com/wronai/planfile/blob/main/docs/coverage.md) |
| `docs/getting-started.md` | Getting started guide | [View](https://github.com/wronai/planfile/blob/main/docs/getting-started.md) |
| `docs/configuration.md` | Configuration reference | [View](https://github.com/wronai/planfile/blob/main/docs/configuration.md) |
| `docs/api-changelog.md` | API change tracking | [View](https://github.com/wronai/planfile/blob/main/docs/api-changelog.md) |
| `CONTRIBUTING.md` | Contribution guidelines | [View](https://github.com/wronai/planfile/blob/main/CONTRIBUTING.md) |
