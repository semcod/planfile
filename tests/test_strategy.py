...
from planfile.models import Sprint, Strategy, Task, TaskType
...
def test_basic_models():
    ...
    strategy = Strategy(
        ...
        sprints=[
            Sprint(
                ...
                tasks=[Task(name="test-task", description="Test task")]
            )
        ],
        tasks={
            "patterns": [
    ...
    assert strategy.get_task_patterns()[0].name == "test-task"
