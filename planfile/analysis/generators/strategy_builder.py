...
def generate_goal(summary: dict[str, Any], metrics: dict[str, Any], focus_area: str | None) -> str:
...
def generate_goals(summary: dict[str, Any], metrics: dict[str, Any], focus_area: str | None) -> list[str]:
...
def parse_effort(effort: str | None) -> int:
...
def generate_success_criteria(metrics: dict[str, Any]) -> list[str]:
    ...
    if 'test_coverage' in metrics:
        criteria.append("Test coverage increased to 80%")
