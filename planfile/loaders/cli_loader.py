...
def load_from_json(file_path: str | Path) -> dict[str, Any]:
    """
...
def save_to_json(data: dict[str, Any], file_path: str | Path) -> None:
    """
...
def load_strategy_from_json(file_path: str | Path) -> Strategy:
    """
...
def save_strategy_to_json(strategy: Strategy, file_path: str | Path) -> None:
    """
...
def export_results_to_markdown(results: dict[str, Any], file_path: str | Path) -> None:
    """
