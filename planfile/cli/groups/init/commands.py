...
_SPRINT_PRESETS: dict[str, list[dict]] = {'api': [{'name': 'Specyfikacja & Architektura', 'duration': '1 tydzień', 'objectives': ['Definicja endpointów (OpenAPI spec)', 'Modele danych (Pydantic)', 'Struktura projektu']}, {'name': 'Implementacja', 'duration': '2 tygodnie', 'objectives': ['CRUD endpoints (FastAPI)', 'Walidacja wejścia', 'Warstwa bazy danych']}, {'name': 'Testowanie', 'duration': '1 tydzień', 'objectives': ['Testy jednostkowe (pytest)', 'Testy integracyjne (TestClient)', 'Pokrycie > 80%']}, {'name': 'Deploy & Monitoring', 'duration': '1 tydzień', 'objectives': ['Dockerfile + docker-compose', 'Pipeline CI/CD', 'Endpoint /health i /metrics']}], 'web': [{'name': 'Fundament & Setup', 'duration': '2 tygodnie', 'objectives': ['Struktura projektu', 'Pipeline CI/CD', 'Autentykacja']}, {'name': 'Główne funkcje', 'duration': '3 tygodnie', 'objectives': ['Logika biznesowa', 'Interfejs użytkownika', 'Warstwa bazy danych']}, {'name': 'Szlif & Deploy', 'duration': '2 tygodnie', 'objectives': ['Optymalizacja wydajności', 'Wzmocnienie bezpieczeństwa', 'Wdrożenie produkcyjne']}], 'cli': [{'name': 'Projekt CLI', 'duration': '1 tydzień', 'objectives': ['Struktura komend', 'Interfejs użytkownika CLI', 'Parsowanie argumentów']}, {'name': 'Implementacja', 'duration': '2 tygodnie', 'objectives': ['Logika komend', 'Obsługa błędów', 'Konfiguracja']}, {'name': 'Testowanie & Publikacja', 'duration': '1 tydzień', 'objectives': ['Testy e2e', 'Dokumentacja', 'PyPI / pakietowanie']}], 'library': [{'name': 'Projektowanie API', 'duration': '1 tydzień', 'objectives': ['Publiczne API biblioteki', 'Typy i interfejsy', 'Dokumentacja architektury']}, {'name': 'Implementacja', 'duration': '2 tygodnie', 'objectives': ['Logika rdzenna', 'Obsługa błędów', 'Typy eksportowane']}, {'name': 'Testy & Release', 'duration': '1 tydzień', 'objectives': ['Testy jednostkowe', 'Testy integracyjne', 'Publikacja pakietu']}], 'custom': []}
_FOCUS_QUALITY_GATES: dict[str, list[dict]] = {'tdd': [{'name': 'Test Coverage', 'description': 'Minimum test coverage', 'criteria': ['pytest --cov >= 80%', 'All tests passing'], 'required': True}], 'security': [{'name': 'Security Scan', 'description': 'No critical vulnerabilities', 'criteria': ['bandit -r . returns 0 critical', 'Dependencies up to date'], 'required': True}], 'performance': [{'name': 'Performance', 'description': 'Response time targets met', 'criteria': ['p95 latency < 200ms', 'No memory leaks'], 'required': True}], 'none': []}
